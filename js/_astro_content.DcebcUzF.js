...
import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, d as renderTemplate, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, r as renderComponent } from "./astro/server.CL5zRllf.js";
import "kleur/colors";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import("./_astro_data-layer-content.4rR1w_dV.js");
...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://findforce.io", "SSR": true };
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import("./_astro_assets.CA-Wu8xc.js").then((n) => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import("./content-modules.B13YiVUt.js");
