...
import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, d as renderTemplate, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, r as renderComponent } from "./astro/server.DeFkX6hJ.js";
import "kleur/colors";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import("./_astro_data-layer-content.BrioapKZ.js");
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import("./_astro_assets.DWB6U5II.js").then((n) => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import("./content-modules.BBPp8-T2.js");
